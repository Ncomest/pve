 ...
 */
export const CRIT_POINTS_TO_FRACTION = 0.015 / 15; // 15 очков ≈ 0.25%
export const EVASION_POINTS_TO_FRACTION = 0.015 / 15; // 15 очков ≈ 0.25%
export const SPEED_POINTS_TO_FRACTION = 0.01 / 15; // 15 очков скорости ≈ 0.25%
export const ARMOR_POINTS_TO_FRACTION = 0.015 / 15; // 15 очков брони ≈ 1% снижения урона
/** 15 очков меткости ≈ 0.25% (как крит) */
export const ACCURACY_POINTS_TO_FRACTION = 0.015 / 15;
/** 15 очков защиты от крита ≈ 0.25% */
export const CRIT_DEFENSE_POINTS_TO_FRACTION = 0.015 / 15;
/** 15 очков самоисцеления ≈ 0.05% урона в лечение */
export const LIFESTEAL_POINTS_TO_FRACTION = 0.008 / 15;
