    ...
    for (const panel of skillsStore.panels) {
      for (const slot of panel) {
        if (
          slot.abilityId &&
          slot.hotkey &&
          slot.hotkey.toLowerCase() === hotkey.toLowerCase()
        ) {
  ...
  <div class="battle-page">
    ...
    <div class="battle-page__dps">
      ...
      <div class="battle-page__dps-item">
        ...
        <span class="battle-page__dps-value"
          >{{ incomingDps.toFixed(1) }}/с</span
        >
      </div>
    </div>
    ...
    <div class="battle-page__arena">
      ...
      <div class="battle-page__card-wrap">
        <BossCard
          ...
          :cast-time-left-ms="
            bossCastState === 'casting' ? bossCastTimeLeftMs : 0
          "
    ...
    <details class="battle-page__stats-mobile">
      <summary class="battle-page__stats-mobile-summary">
        Характеристики
      </summary>
      <div class="battle-page__stats-mobile-content">
        <div
          class="battle-page__stats-panel battle-page__stats-panel--character"
        >
          <h3 class="battle-page__stats-title">Герой</h3>
          <dl class="battle-page__stats-list">
            <div
